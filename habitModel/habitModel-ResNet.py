#!/usr/bin/env python
"""
This script defines a snowflake habit classification model using from transfer learning derived from
...
plt.suptitle("Habit Prediction Performance Using ResNet", fontsize = 24)
plt.savefig(outputDir + 'Habit-ResNet-Performance.png')
